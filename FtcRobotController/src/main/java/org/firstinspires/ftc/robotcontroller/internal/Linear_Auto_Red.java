...
@Autonomous(name = "Red Linear", group = "Auto")
public class Linear_Auto_Red extends LinearOpMode{
    ...
    //Back Into Wall
    private void backIntoWall(ElapsedTime time){
    ...
    //Small Turn
    private void smallTurn(ElapsedTime time){
        leftMotor.setPower(1);
        rightMotor.setPower(0);
    ...
    //Go to wall
    private void driveToWall(ElapsedTime time){
        leftMotor.setPower(1);
        rightMotor.setPower(1);
        leftMotor.setTargetPosition(-5000);
        rightMotor.setTargetPosition(-5000);
    ...
    //Turns to wall
    private void turnToWall(ElapsedTime time){
        leftMotor.setPower(1);
        rightMotor.setPower(0);
